...
import { getJudgment, saveJudgment, saveOrdersRetention } from '../Api';
  ...
  const handleTableSubmit = async () => {
    ...
    try {
      for (const item of tableData) {
        ...
        const response = await saveOrdersRetention(updatedItem);
  ...
  return (
    <div className="transaction-container">
      <form className="transaction-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="retention">Auto de retencion:</label>
          <input
            type="text"
            id="retention"
            name="retention"
